...
\restrict CBdRJnaagkZJDj4rIOcOLNXch0chcsCJo5phPhN5t5d6MWXNGmzUMPNLqJ0OdPL
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.customers TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.prices TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.prices TO authenticated;
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.prices TO service_role;
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.products TO authenticated;
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.subscriptions TO anon;
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE public.subscriptions TO authenticated;
...
\unrestrict CBdRJnaagkZJDj4rIOcOLNXch0chcsCJo5phPhN5t5d6MWXNGmzUMPNLqJ0OdPL
